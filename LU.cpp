...
void sort( vector <string>& taba, vector <int>& tabq, vector <int>& tabw, 
           vector <int>& tabe, vector <int>& tabr, vector <string>& tabt, 
		   vector <string>& taby, vector <int>& tabu, unsigned long long size )
{
